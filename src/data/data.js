...
const removeArticle = (arr, articleToRemove) => arr.filter(article => article.headline !== articleToRemove.headline);
...
const entertainmentArticles = remaining.filter(article => article.category === "entertainment");
const crimeArticles = remaining.filter(article => article.category === "crime");

const recentSweden = pickRandom(swedenArticles);
const recentWorld = pickRandom(worldArticles);
const recentCrime = pickRandom(crimeArticles);
const recentEntertainment = pickRandom(entertainmentArticles);
...
//category
const remainingSweden = removeArticle(swedenArticles, recentSweden);
const remainingWorld = removeArticle(worldArticles, recentWorld);
const remainingCrime = removeArticle(crimeArticles, recentCrime);
const remainingEntertainment = removeArticle(entertainmentArticles, recentEntertainment);
const remainingSport = removeMultiple(sportArticles, displaySport);

export const categoryArticles = [
  { category: "World", articles: pickMultiple(remainingWorld, 3) },
  { category: "Sweden", articles: pickMultiple(remainingSweden, 3) },
  { category: "Sport", articles: pickMultiple(remainingSport, 3) },
  { category: "Entertainment", articles: pickMultiple(remainingEntertainment, 3) },
  { category: "Crime", articles: pickMultiple(remainingCrime, 3) },
];
